...
data modify storage slimecore:in manifest.pack set value "pdata"
data modify storage slimecore:in manifest.version set value {major:1, minor:0, patch:0}
data modify storage slimecore:in manifest.display.name set value "PData"
...
data modify storage slimecore:in manifest.dependencies append value {pack:"varchunk", url:"TODO", version:{major:1, minor:0}}
