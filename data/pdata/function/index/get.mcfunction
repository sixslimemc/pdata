...
execute unless score *x _pdata matches 1 store result score *x _pdata run function pdata:_/impl/index/get/main with storage pdata:in get
execute if score *x _pdata matches 1 store result score *x _pdata run function pdata:_/impl/index/get/main.pathed with storage pdata:in get
