...
execute unless score *get.path_specified _pdata matches 1 store result score *return _pdata run function pdata:_/impl/index/get/main with storage pdata:in get
execute if score *get.path_specified _pdata matches 1 store result score *return _pdata run function pdata:_/impl/index/get/main.pathed with storage pdata:in get
